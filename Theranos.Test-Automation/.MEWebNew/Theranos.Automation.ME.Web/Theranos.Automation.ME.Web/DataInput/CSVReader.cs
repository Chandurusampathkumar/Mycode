...
namespace Theranos.Automation.ME.Web.WebTestScripts.FileReader
{
    [TestClass]
    public class CSVReader
    {
        ...
        public static List<T> GetRecords<T>(string filename)
        {
            ...
            string pat = Path.Combine(Path.GetFullPath(@"C:\Users\chanduru.s\Source\Workspaces\.ME Android\Internal\Input"), pathCSV);
        ...
        {
            string pathCSV = filename;
            string rrpath = Path.Combine(Path.GetFullPath(@"C:\Users\chanduru.s\Source\Workspaces\.ME Android\Internal\Input"), "dump.csv");
            string wrpath = Path.Combine(Path.GetFullPath(@"C:\Users\chanduru.s\Source\Workspaces\.ME Android\Internal\Input"), pathCSV);
