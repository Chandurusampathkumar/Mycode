...
using Theranos.Automation.PSC3.Utility.Input;
...
namespace Theranos.Automation.PSC3.Utility
{
    public class UIAutoHelper
    {
        ...
        public static void SelectFromDropdown(Window appWin, String editBoxId, AutomationElement spinner, String popUpClass, String listItemName, String itemName)
        {
            ...
            do
            {
                Thread.Sleep(5 * AppSettings.WaitTime);
        ...
        public static void SendKeyToWindow(Window window, TestStack.White.UIItems.TextBox textBox, String message)
        {
            ...
            Thread.Sleep(AppSettings.WaitTime);
        ...
        public static void MoveToAndClick(Window appWin, string elementName)
        {
        ...
        {
            System.Windows.Point winPoint=element.Current.BoundingRectangle.TopLeft;
