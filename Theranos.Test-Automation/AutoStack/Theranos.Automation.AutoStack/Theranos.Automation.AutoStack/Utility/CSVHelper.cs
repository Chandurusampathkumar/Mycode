...
{
    public class CSVHelper:AutoStack
    {
        public static List<T> GetRecords<T>(string filename)
        {
            ...
            else if (TestEnvironment==IntegrationEnvironment) //For Integration Environment
            {
                pathCSV = Path.Combine(InputDirectoryIntegration,filename);
            }
            else
            {
